...
params = tuple(london_co[device].keys())
param = input('Enter parameter name {}: '.format(params).replace("'", '')).casefold()
no_msg = 'Такого параметра нет'
print(london_co[device].get(param, no_msg))